...
def summarize_pdf(txt_file_path : str, output_file_path : str):
    txt_file_path = pdf_to_text(txt_file_path)
...
if __name__ == '__main__':
    pdf_file_path = 'data/식물자원분야 - 다시, 광합성을 생각한다.pdf'
    summarize_pdf(pdf_file_path, 'output/plant_model_summary2.txt')